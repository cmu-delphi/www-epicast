...
function registerUser(&$output, $name, $email) {
   ...
   $body = mysql_real_escape_string(sprintf("Hi %s,\r\n\r\nWelcome to Epicast! Here's your User ID: %s\r\nYou can login and begin forecasting here: http://epicast.org/launch.php?user=%s\r\n\r\nThank you,\r\nThe Delphi Team\r\n\r\n[This is an automated message. Please direct all replies to: dfarrow0@gmail.com. Unsubscribe: http://epicast.org/preferences.php?user=%s]", $name, $hash, $hash, $hash));
